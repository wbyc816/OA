<template>
  <div class="searchQAR" v-loading="reportLoading">
    <el-card class="borderCard">
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="6">
          <el-select v-model="params.fromApt" ref="takeOffData"  filterable placeholder="起飞四字码">
        ...
        <el-col :span="6" v-if="!notype">
          <el-select v-model="params.toApt" ref="achieve"  filterable placeholder="到达四字码">
...
　　　},
  ...
  methods: {
    exportExcel(){
     ...
     window.open(this.baseURL+"/foc/exportQBR?flightNo="+this.params.flightNo+"&beginTime="+this.params.beginTime +"&endTime="+this.params.endTime+"&fromApt="+this.params.fromApt+"&toApt="+this.params.toApt )
    ...
    submitParam() {
      if(this.params.fromApt!=""&&this.params.toApt!=""||this.params.fromApt==""&&this.params.toApt==""){

    ...
    <el-dialog title="验证个人密码" size="tiny" :visible.sync="salaryDialogVisible" @close="close">
      <el-form :model="passwordValidateForm" ref="passwordValidateForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="个人密码" prop="password" :rules="[
          ...
          <el-input type="password" v-model="passwordValidateForm.password" auto-complete="off" :maxlength="16"  @keyup.enter.native="submitForm('passwordValidateForm')"></el-input>
        </el-form-item>
        <el-form-item>

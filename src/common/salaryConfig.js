export const salaryLeft = [
	...
	{name: 'inlandFlightHours', label: '上月国内航线小时费',isDeduction:false},
	...
	{name: 'overnightDays', label: '上月空勤人员过夜天数',isDeduction:false},
...
export const salaryRight = [
	...
	{name: 'standardHour', label: '小时费标准'},//飞行/乘务/安全员
	{name: 'inlandTotalContractTime', label: '国内航线承包时间',isDeduction:false},//666
	{name: 'backupsDays', label: '上月备份天数',isDeduction:false},

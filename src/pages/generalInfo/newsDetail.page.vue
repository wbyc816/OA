    ...
    <el-col :span='6' >
      <ul class="sideBox">
        <li v-for="o in 4">
          ...
          <div class="bottom">
            <p>Lean Six Sigma<span class="flRight purple"><i class="iconfont icon-eye"></i><span>215</span></span></p>
            <p><span class="divider">HKA</span>General<span class="flRight">Date：2016-12-22</span></p>
          </div>

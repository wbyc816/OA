          ...
          <el-col :span='24'>
            <div v-show="isPresident!=1">
              <el-card class="mailbox" v-show="new_mail==1">
                ...
                <el-form ref="baseForm" :model="baseForm" label-width="80px" class="baseForm">
                  <el-form-item label="标题">
                    <el-input v-model="baseForm.emailTitle" :maxlength="50"></el-input>
                  </el-form-item>
                  <el-form-item label="内容">
                    <el-input type="textarea" :rows="6" v-model="baseForm.emailContent" class="textarea" resize="none" :maxlength="500"></el-input>
                  </el-form-item>
                  <el-form-item>
              ...
              <el-card class="mailbox_second" v-show="mail_list==1">
                ...
                <el-table :data="MailDatas" stripe style="width: 100%" @row-click="clickRowOther">
                  ...
                  <el-table-column prop="postTime" label="发送时间">
                    <template scope="scope">
            ...
            <div v-show="isPresident==1">
              <el-card class="boss_mailbox" v-show="boss_mail_list==1">
                ...
                <el-table :data="MailDatas" stripe style="width: 100%" @row-click="clickRow">
                  <el-table-column prop="emailTitle" label="标题">
                    <template scope="scope">
                  ...
                  <el-table-column prop="postName" label="发送人">
                    <template scope="scope">
...
export default {
  ...
  methods: {
    bossOnSubmit() {
      ...
      this.$http.post("/index/replyEmail", params, {
        body: true
      }).then(res => {
        setTimeout(function() {

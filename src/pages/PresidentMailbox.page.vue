    ...
    <el-row :gutter='12'>
            ...
            <el-card class="mailbox" style="height:630px;position:relative;" v-show="mail_list==1">
              ...
              <el-table-column
                ...
                <template scope="scope">
                  <div @click="mail_content_detail(scope.row.id)" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;height:20px;width:200px">{{ scope.row.emailTitle}}</div>
                </template>
              </el-table-column>
              <el-table-column
                prop="postTime"
             ...
             <el-card class="mailbox" style="height:457px;" v-show="mail_detail==1">
                ...
                <div style="padding: 18px ;" >
                  <div style="min-height:150px">
                    <div style="width:200px;display:inline-block" >回复人：{{detailDatas.replyName}}</div>   时间：{{detailDatas.replyTime==null ? "" : (detailDatas.replyTime | time("all")) }}
      ...
      <el-col :span='7' class="sideNav" >
        ...
        <el-card class="mailbox" v-show="isPresident==1">
          <el-menu>
            <el-menu-item index="1">总裁邮箱</el-menu-item>
            <el-menu-item index="2" @click="">待回复<span style="margin-left:200px">{{emailNotReplyCount}}</span></el-menu-item>

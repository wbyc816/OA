<template>
  <div id="myBooking">
    <el-card class="borderCard searchOptions">
      ...
      <el-row :gutter="12">
        <el-col :span="8">
          <el-input v-model="searchParams.conferenceTitle" placeholder="会议名称"></el-input>
        </el-col>
        <el-col :span="5">
    ...
    <el-card class="borderCard searchResult" v-loading="searchLoading">
      <el-table :data="searchData" class="myTable">
        <el-table-column prop="ItemNo" label="预定编号" width="130"></el-table-column>
        ...
        <el-table-column label="操作" class-name="clickItem" width="90">
          <template scope="scope">
            ...
            <span class="cancelButton" v-else @click="cancel(scope.row)">取消</span>
          </template>
        </el-table-column>
      </el-table>

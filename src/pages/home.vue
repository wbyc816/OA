      ...
      <el-col :span="8" class="sideBox">
        ...
        <el-card class="Workbench">
          ...
          <el-menu>
            ...
            <el-menu-item index="9" @click.native="goToOthers('/QARData')" v-if="userInfo.isDocsec&&userInfo.isDocsec[4]==1"><i class="iconfont icon-edit" ></i>QAR数据展示<i class="el-icon-arrow-right"></i></el-menu-item>

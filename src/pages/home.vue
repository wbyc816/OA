      ...
      <el-col :span="8" class="sideBox">
        ...
        <el-card class="Workbench">
          ...
          <el-menu>
            ...
            <el-menu-item index="8" @click.native="goToOthers('/flightException')" v-if="userInfo.isDocsec&&userInfo.isDocsec[2]==1"><i class="iconfont icon-99"></i>飞行任务书数据异常监控<i class="el-icon-arrow-right"></i></el-menu-item>
          </el-menu>
        </el-card>

...
export default {
  ...
  created() {
    if (!this.userInfo.isDocsec || this.userInfo.isDocsec[2] != 1) {
...
#flightReport {
  ...
  margin-bottom:30px;
  #highchartsContainerOne,
  #highchartsContainerTwo,
  #highchartsContainerThree,
  #highchartsContainerFour,
  #highchartsContainerFive {
    margin: 20px 0;
  }
}

  ...
  <div id="birthdayReminder">
    <el-row :gutter='12'>
      <el-col :span='17'>
        <el-row>
          <el-col :span="7">
            <div class="grid-content bg-purple" style="margin-bottom:70px"><img src="../assets/images/birthday.png" width="100%" height="579"></div>
          </el-col>
          <el-col :span="17" style="background:#fff">
            <div class="grid-content bg-purple-light">
              ...
              <el-table :data="tableData" stripe style="width: 100%">
                ...
                <el-table-column prop="mobileNumber" label="联系电话" width="130">
                </el-table-column>
              </el-table>
              <div class="pageBox" v-show="tableData.length>0">
                <el-pagination @current-change="handleCurrentChange" :current-page="pageNumber" :page-size="15" layout="total, prev, pager, next, jumper" :total="total">
                </el-pagination>
              </div>
            </div>
          </el-col>

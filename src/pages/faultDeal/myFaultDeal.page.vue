      ...
      <el-collapse-transition>
        <div v-show="showDetail">
          <el-row :gutter="12">
            ...
            <!-- <el-col :span="6">
                <el-input v-model.trim="searchParams.operatorName" placeholder="接障人" :maxlength="50"></el-input>
            </el-col> -->
      ...
      <el-table :data="searchData" class="myTable" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" class-name="clickItem">
          <template scope="scope">
            ...
            <!-- <span class="cancelButton" @click.stop="deletefauleDeal([scope.row.id])">删除</span> -->
          </template>
        </el-table-column>
      </el-table>

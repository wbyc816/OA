<template>
  <div id="paymentSearch">
    <el-card class="borderCard searchOptions">
      <div slot="header">
        <span>Payment Searching</span>
        <i class="iconfont icon-shuaxin"></i>
      </div>
      <el-row :gutter="12">
        <el-col :span="6">
          <el-input placeholder="Ref No."></el-input>
        </el-col>
        <el-col :span="6">
          <el-input placeholder="Budget Nature" icon="icon-jiantou" v-model="handledBy"></el-input>
        </el-col>
        <el-col :span="12">
    ...
    <el-card class="borderCard searchResult">
      ...
      <el-table :data="searchData" class="myTable">      
        <el-table-column prop="RefNo" label="Ref No." width="110"></el-table-column>
        <el-table-column prop="BudgetNature" label="Budget Nature" width="120"></el-table-column>
        <el-table-column prop="AmountRequested" label=" Amount Requested" width="140"></el-table-column>
        <el-table-column prop="AmoutPayable" label="Amout Payable" width="110"></el-table-column>
        <el-table-column prop="PaidAmount" label="Paid Amount" width="110"></el-table-column>
        <el-table-column label="Application Time" width="120">

<template>
  <div class="materialDetail">
    <el-table :data="info[0].materialItem" :stripe="true" highlight-current-row style="margin-bottom:20px;" class="appTable">
    ...
    <el-table :data="info[0].material"   style="width: 100%;" empty-text="未添加材料" class="appTable">

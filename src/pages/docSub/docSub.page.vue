    ...
    <el-card class='doc-block doc-finance'>
      ...
      <el-row :gutter='15'>
        <el-col :span="6" v-for="item in financeData">
          <!-- <doc-list :data='item' disabled disableText="根据财务预算年跨度，该类流程停用，具体启用时间请等待通知。"></doc-list> -->
          <doc-list :data='item'></doc-list>
        </el-col>
      </el-row>
    </el-card>
...
const contrastData = [
  ...
  { 'logo': 'icon-people2', 'color': '#FF5F88', 'text': '人员引进申请', 'link': '/doc/docCommonApp/RYY' },
  ...
  { 'logo': 'icon-file1', 'color': '#5BB5FC', 'text': '员工岗位变动申请', 'link': '/doc/docCommonApp/RSB' },
